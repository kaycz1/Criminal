...
const GAME_DATA = {
  ...
  stages: [
    ...
    { id: 6, name: "Celular da Vítima", key: "phone_bypass" },
    { id: 7, name: "Interrogatórios", key: "interrogations" },
  ...
  clues: {
    ...
    taca_quebrada: {
      ...
      relevance: "Crítica. O fragmento de vidro foi retirado de uma taça quebrada durante a briga física e usado para desferir o golpe fatal na garganta da vítima.",
      unlocked: false
    },
    celular_vitima: {
      id: "celular_vitima",
    ...
    marcas_chao: {
      ...
      relevance: "Média.",
      unlocked: false,
      details: "As marcas indicam que a vítima tentou se agarrar a alguém ou resistir a uma abordagem física violenta antes de ser agredida."
    },
    manchas_sangue: {
      id: "manchas_sangue",
      ...
      relevance: "Alta.",
      unlocked: false,
      details: "Amostras revelam que o sangue pertence exclusivamente a Daniela, resultante da hemorragia causada pelo corte fatal na garganta."
    },
    cadeira_derrubada: {
...
- **ANÁLISE DE SOLO:** Traços do adubo patenteado <b>"Phos-Grow 4"</b> foram achados nas folhas. Este adubo foi proibido pelo IBAMA em 2022. A única estufa com estoque residual licenciado na cidade é a <b>Floricultura Flor de Newton</b>, pertencente à família do suspeito <b>Michel Newton</b>.`,
      logs_geolocalizacao: `<b>📁 IMAGENS_CAMERAS_SEGURANCA.TXT</b><br>
