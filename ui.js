  ...
  class InvestiUI {
    ...
    switchStage(stageNum) {
      ...
      switch (stageNum) {
        ...
        case 6: this.initStagePhoneBypass(); break;
        case 7: this.initStageInterrogations(); break;
    ...
    // ==============================================================
    // 4. LAUDO DA AUTÓPSIA 3D (Etapa 4)
    // ==============================================================
    initStageAutopsy3D() {
    ...
    // ==============================================================
    // 5. FICHA DOS SUSPEITOS POLAROID (Etapa 5)
    // ==============================================================
    initStageSuspects() {
    ...
    // ==============================================================
    // 7. INTERROGATÓRIOS COM IMAGENS (Etapa 7)
    // ==============================================================
      ...
      if (appName === "whatsapp") {
        ...
        display.innerHTML = `
          <div class="phone-files-list">
            ...
            <button class="file-item-btn" onclick="UI.openPhoneFile('logs_geolocalizacao')">📄 IMAGENS_CAMERAS_SEGURANCA.TXT</button>
          </div>
    ...
    // ==============================================================
    // 8. ACUSAÇÃO FINAL & REVELAÇÃO CINEMATOGRÁFICA (Etapa 8)
    // ==============================================================
